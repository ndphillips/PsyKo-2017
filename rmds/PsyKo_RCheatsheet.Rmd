...
```{r}
# Install some packages from the internet (you only need to install packages to your computeronce)
...
true.sd <- 1       # The true population standard dviation
...
mtext(paste("p(Null is FALSE | p < .05) = ", round(with(subset(sim, p < .05), mean(mu != 0)), 2)), side = 3, line = 1)
